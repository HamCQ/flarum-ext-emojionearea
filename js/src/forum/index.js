...
function loadEmojioneArea() {
    ...
    return new Promise(resolve => {
        ...
        style.href = 'https://oss.hamcq.cn/static/emojionearea%403.4.2/emojionearea.min.css';
        document.head.appendChild(style);

        const script = document.createElement('script');
        script.crossOrigin = 'anonymous';
        // script.integrity = 'sha256-ImIFrmJd7ymGlVw2MbtI96BNPW4NfcKqM3d1Go665Ig=';
        script.src = 'https://oss.hamcq.cn/static/emojionearea%403.4.2/emojionearea.min.js';
